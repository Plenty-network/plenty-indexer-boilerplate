...
async def volume_token2_dollar_24hours(symbol_1, symbol_2):
    ...
    try:
        ...
        for i in range(trades_token_range):
            volume_token = volume_token + token_day_trades[i].quantity_tk2

        volume_token2_dollar = Decimal(volume_token * token_price)
    except (TypeError, AttributeError):
        volume_token2_dollar = Decimal(1)

    return volume_token2_dollar
