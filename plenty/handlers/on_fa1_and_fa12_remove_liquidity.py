...
from plenty.types.plenty_fa1_fa12.parameter.remove_liquidity import RemoveLiquidityParameter
...
async def on_fa1_and_fa12_remove_liquidity(
        ctx: HandlerContext,
        remove_liquidity: Transaction[RemoveLiquidityParameter, PlentyFa1Fa12Storage],
    ...
    # SET POOL QUANTITIES AND CALCULATE PRICE
