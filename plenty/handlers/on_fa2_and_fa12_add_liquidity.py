...
from plenty.types.plenty_fa2_fa12.parameter.add_liquidity import AddLiquidityParameter
...
async def on_fa2_and_fa12_add_liquidity(
        ctx: HandlerContext,
        add_liquidity: Transaction[AddLiquidityParameter, PlentyFa2Fa12Storage],
