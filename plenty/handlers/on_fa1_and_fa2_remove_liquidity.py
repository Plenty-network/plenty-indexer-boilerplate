...
from plenty.types.plenty_fa1_fa2.parameter.remove_liquidity import RemoveLiquidityParameter


async def on_fa1_and_fa2_remove_liquidity(
        ctx: HandlerContext,
        remove_liquidity: Transaction[RemoveLiquidityParameter, PlentyFa1Fa2Storage],
